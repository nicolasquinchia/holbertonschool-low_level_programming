#!/usr/bin/python3
"""This Module holds the funtion island perimetermeter
    that calculates the perimetermeter of a grid(island)
    """


def island_perimetermeter(grid):
    """This function Returns the perimetermeter of a grid(island)
